...
export default class Goods extends Component{
    ...
    mouseBind;
    ids;
    static GOODS_SELECTED_EVENT="goods_selected_event";
    ...
    clickHandler(e){
        var evt=new Event(Goods.GOODS_SELECTED_EVENT,{bubbles:true});
        evt.ids=this.ids;
